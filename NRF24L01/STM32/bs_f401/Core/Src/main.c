...
int main(void)
{
  ...
  MX_TIM1_Init();
  /* USER CODE BEGIN 2 */
	LL_TIM_EnableCounter(TIM1);												//включение счетчика
	LL_TIM_EnableIT_UPDATE(TIM1);											//разрешение прерываний по сравнению
...
void SystemClock_Config(void)
{
  ...
  LL_RCC_PLL_ConfigDomain_SYS(LL_RCC_PLLSOURCE_HSI, LL_RCC_PLLM_DIV_8, 72, LL_RCC_PLLP_DIV_2);
  LL_RCC_PLL_Enable();
