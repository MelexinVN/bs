...
#include "main.h"
//------------------------------------------------
//если менять местами CE и CSN
//#define CE_RESET LL_GPIO_ResetOutputPin(CSN_GPIO_Port, CSN_Pin)
//#define CE_SET LL_GPIO_SetOutputPin(CSN_GPIO_Port, CSN_Pin)
...
#define TX_PLOAD_WIDTH 32					//размер полезной нагрузки (максимальное значение)
