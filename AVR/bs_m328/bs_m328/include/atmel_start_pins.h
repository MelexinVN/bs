 ...
 */
static inline void CE_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(0, pull_mode);
}

/**
 * \brief Set CE data direction
 *
 ...
 *                      (low power state)
 */
static inline void CE_set_dir(const enum port_dir dir)
{
 ...
 */
static inline void CE_set_level(const bool level)
{
	PORTB_set_pin_level(0, level);
}

/**
 * \brief Toggle output level on CE
 *
 * Toggle the pin level
 */
static inline void CE_toggle_level()
{
	PORTB_toggle_pin_level(0);
}

/**
 * \brief Get level on CE
 *
 * Reads the level on a pin
 */
static inline bool CE_get_level()
{
 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void IRQ_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTD_set_pin_pull_mode(2, pull_mode);
}

/**
 * \brief Set IRQ data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void IRQ_set_dir(const enum port_dir dir)
{
 ...
 *                  false = Pin level set to "low" state
 */
static inline void IRQ_set_level(const bool level)
{
	PORTD_set_pin_level(2, level);
}

/**
 * \brief Toggle output level on IRQ
 *
 * Toggle the pin level
 */
static inline void IRQ_toggle_level()
{
	PORTD_toggle_pin_level(2);
}

/**
 * \brief Get level on IRQ
 *
 * Reads the level on a pin
 */
static inline bool IRQ_get_level()
{
	return PORTD_get_pin_level(2);
}

/**
 * \brief Set BUT pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void BUT_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTD_set_pin_pull_mode(3, pull_mode);
}

/**
 * \brief Set BUT data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void BUT_set_dir(const enum port_dir dir)
{
 ...
 *                  false = Pin level set to "low" state
 */
static inline void BUT_set_level(const bool level)
{
	PORTD_set_pin_level(3, level);
}

/**
 * \brief Toggle output level on BUT
 *
 * Toggle the pin level
 */
static inline void BUT_toggle_level()
{
	PORTD_toggle_pin_level(3);
}

/**
 * \brief Get level on BUT
 *
 * Reads the level on a pin
 */
static inline bool BUT_get_level()
{
 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void CSN_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTD_set_pin_pull_mode(7, pull_mode);
}

/**
 * \brief Set CSN data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void CSN_set_dir(const enum port_dir dir)
{
 ...
 *                  false = Pin level set to "low" state
 */
static inline void CSN_set_level(const bool level)
{
	PORTD_set_pin_level(7, level);
}

/**
 * \brief Toggle output level on CSN
 *
 * Toggle the pin level
 */
static inline void CSN_toggle_level()
{
	PORTD_toggle_pin_level(7);
}

/**
 * \brief Get level on CSN
 *
 * Reads the level on a pin
 */
static inline bool CSN_get_level()
{
